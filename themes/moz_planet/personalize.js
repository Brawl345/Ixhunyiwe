...
function addOption(event) {
  ...
  if (h2 != null && !document.getElementById("navkeys")) {
    h2.appendChild(document.createTextNode('Optionen'));
    ...
    a.title = "Einträge navigieren";
    a.appendChild(document.createTextNode('Akitiviere '));
    var code = document.createElement('code');
    code.appendChild(document.createTextNode('N'));
    a.appendChild(code);
    a.appendChild(document.createTextNode(' und '));
    code = document.createElement('code');
    code.appendChild(document.createTextNode('P'));
    a.appendChild(code);
    a.appendChild(document.createTextNode(' Tasten'));
    p.appendChild(a);
    form.appendChild(p);
