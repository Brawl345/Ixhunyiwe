  ...
  <xsl:template match="atom:feed">
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <head>
        ...
        <link rel="shortcut icon" href="https://andibi.tk/favicon.ico" />
      ...
      <body>
		...
		<a class="navbar-brand" href="{atom:link}"><xsl:value-of select="atom:title"/></a>
		</nav>
        ...
        <div id="sidebar" class="jumbotron">
          ...
          <dl>
		    <dt>Was ist das hier?</dt>
			<p>Das ist ein sogenannter "Planet". Dieser aggregiert die obenstehenden Feeds und zeigt sie hier an.</p>
			<dt>"Ixhunyiwe"?</dt>
			<p><strong>Ixhunyiwe</strong> kommt aus der Sprache der Zulu und bedeutet "verbunden".</p>
            ...
            <dd>
              <ul>
                <li>
                  <a href="opml.xml">
                    <img src="images/opml-new.png" alt="OPML"/>
                  </a>
                </li>
                <li>
                  <a href="foafroll.xml">
